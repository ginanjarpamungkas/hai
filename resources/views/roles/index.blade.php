...
<div class="page-title">
    <div class="title_left">
        <h3>Role <small>Some examples to get you started</small></h3>
    </div>
               ...
               <div class="" role="tabpanel" data-example-id="togglable-tabs">
                   ...
                   <div id="myTabContent" class="tab-content">
                                 ...
                                 @foreach ($roles as $role)
                                    <tr class="even pointer">
                                      ...
                                      <td class="text-center">
                                         <a href="{{url('roles', $role->id)}}" class="btn btn-sm btn-primary"><i class="fa fa-file"></i> </a>
                                         <a href="{{url('roles/destroy', $role->id)}}" class="btn btn-sm btn-danger" onclick="javasciprt: return confirm('Are you sure to delete this role')"><i class="fa fa-trash"></i> </a>
                                      </td>
                                   </tr>
                                 @endforeach
                              </tbody>
                       ...
                       <div role="tabpanel" class="tab-pane fade" id="tab_content3" aria-labelledby="profile-tab">
                          <form class="form-horizontal form-label-left" method="post" action="{{url('roles')}}">
                             {{csrf_field()}}
